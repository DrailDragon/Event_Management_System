...
namespace practise_2 {
	...
	/// <summary>
	/// Summary for Manage_calendar
	/// </summary>
	public ref class Manage_calendar : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Manage_calendar::button1_Click);
			// 
			// label1
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Manage_calendar::button2_Click);
			// 
			// time_del
			// 
			...
			this->Load += gcnew System::EventHandler(this, &Manage_calendar::Manage_calendar_Load);
...
#pragma endregion
	private: System::Void Manage_calendar_Load(System::Object^  sender, System::EventArgs^  e) {
			 }
